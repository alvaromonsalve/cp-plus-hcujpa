 ...
 */
@Entity
@Table(name = "hosp_evo_egreso")
@NamedQueries({
    @NamedQuery(name = "HospEvoEgreso.findAll", query = "SELECT h FROM HospEvoEgreso h")})
public class HospEvoEgreso implements Serializable {
    ...
    public HospEvoEgreso() {
    }

    public HospEvoEgreso(Integer id) {
        this.id = id;
    }

    public HospEvoEgreso(Integer id, HospEvolucion idHospEvolucion, int usuario, Date fDigita) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospEvoEgreso)) {
            return false;
        }
        HospEvoEgreso other = (HospEvoEgreso) object;
    ...
    public String toString() {
        return "entidades.HospEvoEgreso[ id=" + id + " ]";
    }
