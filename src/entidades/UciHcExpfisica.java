 ...
 */
@Entity
@Table(name = "uci_hc_expfisica")
@NamedQueries({
    @NamedQuery(name = "UciHcExpfisica.findAll", query = "SELECT i FROM UciHcExpfisica i")})
public class UciHcExpfisica implements Serializable {
    ...
    public UciHcExpfisica() {
    }

    public UciHcExpfisica(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciHcExpfisica)) {
            return false;
        }
        UciHcExpfisica other = (UciHcExpfisica) object;
    ...
    public String toString() {
        return "entidades.UciHcExpfisica[ id=" + id + " ]";
    }
