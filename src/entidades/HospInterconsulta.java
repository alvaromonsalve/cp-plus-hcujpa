 ...
 */
@Entity
@Table(name = "hosp_interconsulta")
@NamedQueries({
    @NamedQuery(name = "HospInterconsulta.findAll", query = "SELECT i FROM HospInterconsulta i")})
    public class HospInterconsulta implements Serializable {
    ...
    public HospInterconsulta() {
    }

    public HospInterconsulta(Integer id) {
        this.id = id;
    }

    public HospInterconsulta(Integer id, int idHistoriac, int idEspecialidades) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospInterconsulta)) {
            return false;
        }
        HospInterconsulta other = (HospInterconsulta) object;
    ...
    public String toString() {
        return "entidades.HospInterconsulta[ id=" + id + " ]";
    }
