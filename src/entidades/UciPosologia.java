 ...
 */
@Entity
@Table(name = "uci_posologia")
@NamedQueries({
    @NamedQuery(name = "UciPosologia.findAll", query = "SELECT i FROM UciPosologia i")})
public class UciPosologia implements Serializable {
    ...
    public UciPosologia(Integer id) {
        this.id = id;
    }

    public UciPosologia(Integer id, SumSuministro idSuministro, UciHistoriac idHistoriac, int usuario, Date fdigita) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciPosologia)) {
            return false;
        }
        UciPosologia other = (UciPosologia) object;
