 ...
 */
@Entity
@Table(name = "uce_hoja_tratamientos")
@NamedQueries({
    @NamedQuery(name = "UceHojaTratamientosH.findAll", query = "SELECT u FROM UceHojaTratamientosH u")})
public class UceHojaTratamientosH implements Serializable {
    ...
    public UceHojaTratamientosH() {
    }

    public UceHojaTratamientosH(Integer id) {
        this.id = id;
    }

    public UceHojaTratamientosH(Integer id, Date fechaIngresoDatos) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UceHojaTratamientosH)) {
            return false;
        }
        UceHojaTratamientosH other = (UceHojaTratamientosH) object;
    ...
    public String toString() {
        return "entidades_EJB.UceHojaTratamientosH[ id=" + id + " ]";
    }
