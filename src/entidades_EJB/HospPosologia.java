 ...
 */
@Entity
@Table(name = "hosp_posologia")
@NamedQueries({
    @NamedQuery(name = "HospPosologia.findAll", query = "SELECT i FROM HospPosologia i")})
public class HospPosologia implements Serializable {
    ...
    public HospPosologia() {
    }

    public HospPosologia(Integer id) {
        this.id = id;
    }

    public HospPosologia(Integer id, SumSuministro idSuministro, HospHistoriac idHistoriac, int usuario, Date fdigita) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospPosologia)) {
            return false;
        }
        HospPosologia other = (HospPosologia) object;
