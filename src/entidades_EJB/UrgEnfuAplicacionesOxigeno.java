...
@NamedQueries({
    @NamedQuery(name = "UrgEnfuAplicacionesOxigeno.findAll", query = "SELECT u FROM UrgEnfuAplicacionesOxigeno u")})
public class UrgEnfuAplicacionesOxigeno implements Serializable {
    ...
    public UrgEnfuAplicacionesOxigeno() {
    }

    public UrgEnfuAplicacionesOxigeno(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UrgEnfuAplicacionesOxigeno)) {
            return false;
        }
        UrgEnfuAplicacionesOxigeno other = (UrgEnfuAplicacionesOxigeno) object;
    ...
    public String toString() {
        return "entidades_EJB.UrgEnfuAplicacionesOxigeno[ id=" + id + " ]";
    }
