...
public class UciGlasgow implements Serializable {
    ...
    public UciGlasgow(Integer id) {
        this.id = id;
    }

    public UciGlasgow(Integer id, int ao, int rv, int rm, Character estado, Date fechaIngresoDatos) {
        this.id = id;
        this.ao = ao;
        this.rv = rv;
        this.rm = rm;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciGlasgow)) {
            return false;
        }
        UciGlasgow other = (UciGlasgow) object;
