...
@NamedQueries({
    @NamedQuery(name = "UrgEnfuControlDiableticos.findAll", query = "SELECT u FROM UrgEnfuControlDiableticos u")})
public class UrgEnfuControlDiableticos implements Serializable {
    ...
    public UrgEnfuControlDiableticos() {
    }

    public UrgEnfuControlDiableticos(Integer id) {
        this.id = id;
    }

    public UrgEnfuControlDiableticos(Integer id, Date fechaIngresoDato) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UrgEnfuControlDiableticos)) {
            return false;
        }
        UrgEnfuControlDiableticos other = (UrgEnfuControlDiableticos) object;
    ...
    public String toString() {
        return "entidades_EJB.UrgEnfuControlDiableticos[ id=" + id + " ]";
    }
