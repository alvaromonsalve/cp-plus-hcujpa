...
public class UciOrdenProcedimientoDesc implements Serializable {
    ...
    private UciOrdenProcedimiento idOrdenProcedimiento;
    @Basic(optional = false)
    ...
    public UciOrdenProcedimientoDesc(Integer id, int idConfigCups, int estado) {
        this.id = id;
    ...
    public UciOrdenProcedimiento getIdOrdenProcedimiento() {
        return idOrdenProcedimiento;
    }

    public void setIdOrdenProcedimiento(UciOrdenProcedimiento idOrdenProcedimiento) {
