...
public class HospEnfLogs implements Serializable {
    ...
    public HospEnfLogs(Integer id) {
        this.id = id;
    }

    public HospEnfLogs(Integer id, int accion, int usuario, int indicador, char estado, Date fechaIng) {
        this.id = id;
        this.accion = accion;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospEnfLogs)) {
            return false;
        }
        HospEnfLogs other = (HospEnfLogs) object;
