 ...
 */
@Entity
@Table(name = "uci_finalizaciones_oxigeno")
@XmlRootElement
@NamedQueries({
...
public class UciFinalizacionesOxigeno implements Serializable {
    ...
    private UciAplicacionesOxigeno idAplicacion;

    public UciFinalizacionesOxigeno() {
    }

    public UciFinalizacionesOxigeno(Integer id) {
        this.id = id;
    }
    ...
    public UciAplicacionesOxigeno getIdAplicacion() {
        return idAplicacion;
    }

    public void setIdAplicacion(UciAplicacionesOxigeno idAplicacion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciFinalizacionesOxigeno)) {
            return false;
        }
        UciFinalizacionesOxigeno other = (UciFinalizacionesOxigeno) object;
