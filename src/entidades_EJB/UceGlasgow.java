...
public class UceGlasgow implements Serializable {
    ...
    public UceGlasgow(Integer id) {
        this.id = id;
    }

    public UceGlasgow(Integer id, int ao, int rv, int rm, Character estado, Date fechaIngresoDatos) {
        this.id = id;
        this.ao = ao;
        this.rv = rv;
        this.rm = rm;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UceGlasgow)) {
            return false;
        }
        UceGlasgow other = (UceGlasgow) object;
