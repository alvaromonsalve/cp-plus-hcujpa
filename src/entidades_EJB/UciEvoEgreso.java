 ...
 */
@Entity
@Table(name = "uci_evo_egreso")
@NamedQueries({
    @NamedQuery(name = "UciEvoEgreso.findAll", query = "SELECT h FROM UciEvoEgreso h")})
public class UciEvoEgreso implements Serializable {
    ...
    public UciEvoEgreso(Integer id) {
        this.id = id;
    }

    public UciEvoEgreso(Integer id, UciEvolucion idUciEvolucion, int usuario, Date fDigita) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciEvoEgreso)) {
            return false;
        }
        UciEvoEgreso other = (UciEvoEgreso) object;
    ...
    public String toString() {
        return "entidades.UciEvoEgreso[ id=" + id + " ]";
    }
