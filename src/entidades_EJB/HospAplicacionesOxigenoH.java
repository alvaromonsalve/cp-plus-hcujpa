...
@NamedQueries({
    @NamedQuery(name = "HospAplicacionesOxigenoH.findAll", query = "SELECT h FROM HospAplicacionesOxigenoH h")})
public class HospAplicacionesOxigenoH implements Serializable {
    ...
    public HospAplicacionesOxigenoH() {
    }

    public HospAplicacionesOxigenoH(Integer id) {
        this.id = id;
    }

    public HospAplicacionesOxigenoH(Integer id, int medico) {
        this.id = id;
        this.medico = medico;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospAplicacionesOxigenoH)) {
            return false;
        }
        HospAplicacionesOxigenoH other = (HospAplicacionesOxigenoH) object;
    ...
    public String toString() {
        return "entidades_EJB.HospAplicacionesOxigenoH[ id=" + id + " ]";
    }
