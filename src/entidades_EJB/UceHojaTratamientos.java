...
public class UceHojaTratamientos implements Serializable {
    ...
    public UceHojaTratamientos() {
    }

    public UceHojaTratamientos(Integer id) {
        this.id = id;
    }

    public UceHojaTratamientos(Integer id, Date fechaIngresoDatos) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UceHojaTratamientos)) {
            return false;
        }
        UceHojaTratamientos other = (UceHojaTratamientos) object;
