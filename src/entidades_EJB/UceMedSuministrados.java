 ...
 */
@Entity
@Table(name = "uce_med_suministrados")
@XmlRootElement
@NamedQueries({
...
public class UceMedSuministrados implements Serializable {
    ...
    public UceMedSuministrados() {
    }

    public UceMedSuministrados(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UceMedSuministrados)) {
            return false;
        }
        UceMedSuministrados other = (UceMedSuministrados) object;
