...
public class HospControlDiableticos implements Serializable {
    ...
    public HospControlDiableticos() {
    }

    public HospControlDiableticos(Integer id) {
        this.id = id;
    }

    public HospControlDiableticos(Integer id, Date fechaIngresoDato) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospControlDiableticos)) {
            return false;
        }
        HospControlDiableticos other = (HospControlDiableticos) object;
