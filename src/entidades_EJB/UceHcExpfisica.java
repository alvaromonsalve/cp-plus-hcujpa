 ...
 */
@Entity
@Table(name = "uce_hc_expfisica")
@NamedQueries({
    @NamedQuery(name = "UceHcExpfisica.findAll", query = "SELECT i FROM UceHcExpfisica i")})
public class UceHcExpfisica implements Serializable {
    ...
    public UceHcExpfisica() {
    }

    public UceHcExpfisica(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UceHcExpfisica)) {
            return false;
        }
        UceHcExpfisica other = (UceHcExpfisica) object;
    ...
    public String toString() {
        return "entidades.UceHcExpfisica[ id=" + id + " ]";
    }
