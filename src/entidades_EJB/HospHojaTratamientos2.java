 ...
 */
@Entity
@Table(name = "hosp_hoja_tratamientos2")
@XmlRootElement
@NamedQueries({
...
public class HospHojaTratamientos2 implements Serializable {
    ...
    public HospHojaTratamientos2() {
    }

    public HospHojaTratamientos2(Integer id) {
        this.id = id;
    }

    public HospHojaTratamientos2(Integer id, int idIngOEvo, Date fechaIngresoDatos) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospHojaTratamientos2)) {
            return false;
        }
        HospHojaTratamientos2 other = (HospHojaTratamientos2) object;
