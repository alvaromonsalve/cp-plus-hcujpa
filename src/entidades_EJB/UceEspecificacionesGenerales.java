 ...
 */
@Entity
@Table(name = "uce_especificaciones_generales")
@XmlRootElement
@NamedQueries({
...
public class UceEspecificacionesGenerales implements Serializable {
    ...
    private UceFactsNotas idFactsNotas;

    public UceEspecificacionesGenerales() {
    }

    public UceEspecificacionesGenerales(Integer id) {
        this.id = id;
    }
    ...
    public UceFactsNotas getIdFactsNotas() {
        return idFactsNotas;
    }

    public void setIdFactsNotas(UceFactsNotas idFactsNotas) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UceEspecificacionesGenerales)) {
            return false;
        }
        UceEspecificacionesGenerales other = (UceEspecificacionesGenerales) object;
