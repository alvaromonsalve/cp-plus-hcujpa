 ...
 */
@Entity
@Table(name = "hosp_hc_expfisica")
@NamedQueries({
    @NamedQuery(name = "HospHcExpfisica.findAll", query = "SELECT i FROM HospHcExpfisica i")})
public class HospHcExpfisica implements Serializable {
    ...
    public HospHcExpfisica() {
    }

    public HospHcExpfisica(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospHcExpfisica)) {
            return false;
        }
        HospHcExpfisica other = (HospHcExpfisica) object;
    ...
    public String toString() {
        return "entidades.HospHcExpfisica[ id=" + id + " ]";
    }
