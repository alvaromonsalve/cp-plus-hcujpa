 ...
 */
@Entity
@Table(name = "enfu_posologia")
@NamedQueries({
    @NamedQuery(name = "EnfuPosologia.findAll", query = "SELECT e FROM EnfuPosologia e")})
public class EnfuPosologia implements Serializable {
    ...
    public EnfuPosologia() {
    }

    public EnfuPosologia(Integer id) {
        this.id = id;
    }

    public EnfuPosologia(Integer id, SumSuministro idSuministro, InfoHistoriac idHistoriac, int usuario, Date fdigita) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EnfuPosologia)) {
            return false;
        }
        EnfuPosologia other = (EnfuPosologia) object;
    ...
    public String toString() {
        return "entidades_EJB.EnfuPosologia[ id=" + id + " ]";
    }
