 ...
 */
@Entity
@Table(name = "hosp_med_suministrados")
@XmlRootElement
@NamedQueries({
...
public class HospMedSuministrados implements Serializable {
    ...
    public HospMedSuministrados() {
    }

    public HospMedSuministrados(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospMedSuministrados)) {
            return false;
        }
        HospMedSuministrados other = (HospMedSuministrados) object;
