 ...
 */
@Entity
@Table(name = "uce_signos_vitales_det")
@XmlRootElement
@NamedQueries({
...
public class UceSignosVitalesDet implements Serializable {
    ...
    public UceSignosVitalesDet() {
    }

    public UceSignosVitalesDet(Integer id) {
        this.id = id;
    }

    public UceSignosVitalesDet(Integer id, Date fechaIngresoDatos) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UceSignosVitalesDet)) {
            return false;
        }
        UceSignosVitalesDet other = (UceSignosVitalesDet) object;
