 ...
 */
@Entity
@Table(name = "uci_interconsulta")
@NamedQueries({
    @NamedQuery(name = "UciInterconsulta.findAll", query = "SELECT i FROM UciInterconsulta i")})
    public class UciInterconsulta implements Serializable {
    ...
    public UciInterconsulta() {
    }

    public UciInterconsulta(Integer id) {
        this.id = id;
    }

    public UciInterconsulta(Integer id, int idHistoriac, int idEspecialidades) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciInterconsulta)) {
            return false;
        }
        UciInterconsulta other = (UciInterconsulta) object;
    ...
    public String toString() {
        return "entidades.UciInterconsulta[ id=" + id + " ]";
    }
