...
@NamedQueries({
    @NamedQuery(name = "UciControlDiableticosH.findAll", query = "SELECT u FROM UciControlDiableticosH u")})
public class UciControlDiableticosH implements Serializable {
    ...
    public UciControlDiableticosH() {
    }

    public UciControlDiableticosH(Integer id) {
        this.id = id;
    }

    public UciControlDiableticosH(Integer id, Date fechaIngresoDato) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciControlDiableticosH)) {
            return false;
        }
        UciControlDiableticosH other = (UciControlDiableticosH) object;
    ...
    public String toString() {
        return "entidades_EJB.UciControlDiableticosH[ id=" + id + " ]";
    }
