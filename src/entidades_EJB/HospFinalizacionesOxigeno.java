 ...
 */
@Entity
@Table(name = "hosp_finalizaciones_oxigeno")
@XmlRootElement
@NamedQueries({
...
public class HospFinalizacionesOxigeno implements Serializable {
    ...
    private HospAplicacionesOxigeno idAplicacion;

    public HospFinalizacionesOxigeno() {
    }

    public HospFinalizacionesOxigeno(Integer id) {
        this.id = id;
    }
    ...
    public HospAplicacionesOxigeno getIdAplicacion() {
        return idAplicacion;
    }

    public void setIdAplicacion(HospAplicacionesOxigeno idAplicacion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospFinalizacionesOxigeno)) {
            return false;
        }
        HospFinalizacionesOxigeno other = (HospFinalizacionesOxigeno) object;
