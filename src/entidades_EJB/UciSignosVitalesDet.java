 ...
 */
@Entity
@Table(name = "uci_signos_vitales_det")
@XmlRootElement
@NamedQueries({
...
public class UciSignosVitalesDet implements Serializable {
    ...
    public UciSignosVitalesDet() {
    }

    public UciSignosVitalesDet(Integer id) {
        this.id = id;
    }

    public UciSignosVitalesDet(Integer id, Date fechaIngresoDatos) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciSignosVitalesDet)) {
            return false;
        }
        UciSignosVitalesDet other = (UciSignosVitalesDet) object;
