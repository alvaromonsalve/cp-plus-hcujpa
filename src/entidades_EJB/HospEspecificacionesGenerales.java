 ...
 */
@Entity
@Table(name = "hosp_especificaciones_generales")
@XmlRootElement
@NamedQueries({
...
public class HospEspecificacionesGenerales implements Serializable {
    ...
    public HospEspecificacionesGenerales() {
    }

    public HospEspecificacionesGenerales(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HospEspecificacionesGenerales)) {
            return false;
        }
        HospEspecificacionesGenerales other = (HospEspecificacionesGenerales) object;
