...
public class UceEnfLogs implements Serializable {
    ...
    public UceEnfLogs(Integer id) {
        this.id = id;
    }

    public UceEnfLogs(Integer id, int accion, int usuario, int indicador, char estado, Date fechaIng) {
        this.id = id;
        this.accion = accion;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UceEnfLogs)) {
            return false;
        }
        UceEnfLogs other = (UceEnfLogs) object;
