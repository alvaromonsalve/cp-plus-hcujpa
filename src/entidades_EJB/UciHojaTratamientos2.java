 ...
 */
@Entity
@Table(name = "uci_hoja_tratamientos2")
@XmlRootElement
@NamedQueries({
...
public class UciHojaTratamientos2 implements Serializable {
    ...
    public UciHojaTratamientos2() {
    }

    public UciHojaTratamientos2(Integer id) {
        this.id = id;
    }

    public UciHojaTratamientos2(Integer id, int idIngOEvo, Date fechaIngresoDatos) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UciHojaTratamientos2)) {
            return false;
        }
        UciHojaTratamientos2 other = (UciHojaTratamientos2) object;
